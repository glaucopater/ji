...
export const LeftLeg = ({
  ...
  upperLegLeftRef: React.RefObject<THREE.Group<THREE.Object3DEventMap>>;
  lowerLegLeftRef: React.RefObject<THREE.Group<THREE.Object3DEventMap>>;
  kneeLeftRef: React.RefObject<THREE.Group<THREE.Object3DEventMap>>;
}) => (
