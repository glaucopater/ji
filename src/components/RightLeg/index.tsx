...
export const RightLeg = ({
  ...
  upperLegRightRef: React.RefObject<THREE.Group<THREE.Object3DEventMap>>;
  lowerLegRightRef: React.RefObject<THREE.Group<THREE.Object3DEventMap>>;
  kneeRightRef: React.RefObject<THREE.Group<THREE.Object3DEventMap>>;
}) => (
